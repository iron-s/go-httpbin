...
func TestAnything(t *testing.T) {
	...
	tests := []struct {
		...
		{"DELETE", "/anything?k1=v1&k1=v2&k3=v3", []byte(`{[{"k1": "v1"}]}`),
			map[string]interface{}{"k1": []interface{}{"v1", "v2"}, "k3": "v3"}},
		{"GET", "/anything/anything/and/more?k1=v1&k1=v2&k3=v3", nil,
			map[string]interface{}{"k1": []interface{}{"v1", "v2"}, "k3": "v3"}},
		{"HEAD", "/anything/anything/and/more?k1=v1&k1=v2&k3=v3", nil,
			map[string]interface{}{"k1": []interface{}{"v1", "v2"}, "k3": "v3"}},
		{"OPTIONS", "/anything/anything/and/more?k1=v1&k1=v2&k3=v3", nil,
			map[string]interface{}{"k1": []interface{}{"v1", "v2"}, "k3": "v3"}},
		{"POST", "/anything/anything/and/more?k1=v1&k1=v2&k3=v3", []byte(`{[{"k1": "v1"}]}`),
			map[string]interface{}{"k1": []interface{}{"v1", "v2"}, "k3": "v3"}},
		{"PUT", "/anything/anything/and/more?k1=v1&k1=v2&k3=v3", []byte(`{[{"k1": "v1"}]}`),
			map[string]interface{}{"k1": []interface{}{"v1", "v2"}, "k3": "v3"}},
		{"PATCH", "/anything/anything/and/more?k1=v1&k1=v2&k3=v3", []byte(`{[{"k1": "v1"}]}`),
			map[string]interface{}{"k1": []interface{}{"v1", "v2"}, "k3": "v3"}},
		{"DELETE", "/anything/anything/and/more?k1=v1&k1=v2&k3=v3", []byte(`{[{"k1": "v1"}]}`),
			map[string]interface{}{"k1": []interface{}{"v1", "v2"}, "k3": "v3"}},
	}
